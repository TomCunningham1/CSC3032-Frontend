    ...
    <Fragment>
        ...
        <div className="instructions container">
            ...
            <ul className="browser-default" id="main-list">
                <li>The scenerio has a duration of 6 minutes and ends as soon the time ends.</li>
                ...
                <li>
                    Select the option which you believe answers the question most accurately by clicking on it.
                ...
                <li>Feel free to quit the scenerio at anytime. You will be given a score at the end</li>
                <li>The timer starts as soon as the game loads.</li>
                <li>Do you think you have what it takes?</li>
            </ul>
            <div>
                <span className="left"><Link to="/">Take me back to the main menu</Link></span>
                <span className="right"><Link to="/play/quiz">Play Quiz</Link></span>
            </div>
        </div>
    </Fragment>
);
