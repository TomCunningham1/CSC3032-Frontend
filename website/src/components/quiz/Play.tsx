            ...
            <Fragment>
                ...
                <div className="questions">
                    ...
                    <div className="lifeline-container">
                        <p>
                            <span onClick={this.handleFiftyFifty} className="mdi mdi-cellphone-basic mdi-24px lifeline-icon"> 
                                <span className="lifeline">{fiftyFifty}</span>
                            </span>
                        </p>
                        <p>
                            <span onClick={this.handleHints} className="mdi mdi-puzzle mdi-24px lifeline-icon">
                    ...
                    <div className="timer-container">
                        <p>
                            ...
                            <span  className="mdi mdi-clock mdi-24px"></span></span>
                        </p>
                    </div>
