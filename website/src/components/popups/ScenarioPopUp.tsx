...
const ScenarioPopUp = ({open, onClose} : any) => {
    ...
    return(
        <div className="popup">
            ...
            <button className="home-btn" onClick={chooseSQLInjection}>SQL Injection</button>
            <button className="home-btn" onClick={chooseBufferOverflow}>Buffer Overflow</button>
            <button className="home-btn" onClick={chooseXSS}>Cross Site Scripting</button>
            <button className="home-btn" onClick={chooseDDoS}>Distributed Denial of Service</button>
        </div>
    )
